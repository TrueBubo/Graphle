...
import com.graphle.AddFileMutation
import com.graphle.AddRelationshipToFileWithNameAndValueMutation
import com.graphle.AddRelationshipToFileWithNameMutation
import com.graphle.AddTagToFileWithNameAndValueMutation
...
private suspend fun ApolloClient.removeTag(
    location: String,
    tag: Tag
): ApolloResponse<RemoveTagMutation.Data> = mutation(
    RemoveTagMutation(
