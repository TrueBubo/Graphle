...
The section introduces the user roles and the user stories gathered from them, which motivate the functional and
qualitative requirements, including semantic and hierarchical #voc("connection") support,
