...
#table(
  ...
  [F4], [Must], [File manipulation], [The user can create, open, delete, and move files through Graphle, and the change is reflected in the underlying #voc("filesystem").], [@uc-create-file, @uc-open-file, @uc-delete-file, @uc-move-file],
  [F5], [Must], [Folders work as files], [A folder can be browsed, tagged, connected by relationships, moved, and deleted through the same workflows as a file.], [@uc-search-file, @uc-add-tag, @uc-add-relationship, @uc-move-file, @uc-delete-file],
