...
Backend access is split between two transports: Apollo GraphQL for all file, tag, and connection operations, and Ktor for the DSL REST call and for the autocomplete WebSocket.
